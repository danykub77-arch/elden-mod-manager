...
// Custom types
// =================================
pub type FloatVector3 = (f32, f32, f32);
pub type FloatVector4 = (f32, f32, f32, f32);
pub type MapId = [u8; 4];
// =================================
...
impl Util {
    pub fn read_wstring<R: std::io::Read>(
    ...
    pub fn write_wstring<R: std::io::Write>(
    ...
    pub fn update_checksum(bytes: &mut Vec<u8>) {
